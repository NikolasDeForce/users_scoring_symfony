...
class __TwigTemplate_5b3914448191facff9a139ae1777db73 extends Template
{
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 19, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "</td>
                <td>";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "firstName", [], "any", false, false, false, 22), "html", null, true);
            yield "</td>
                <td>";
            // line 23
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "lastName", [], "any", false, false, false, 23), "html", null, true);
            yield "</td>
                <td>";
            // line 24
        ...
        if (!$context['_iterated']) {
            // line 31
            yield "            <tr>
                <td colspan=\"9\">В таблице отсутствуют записи клиентов</td>
            </tr>
        ";
        }
    ...
    <div class=\"mb-3\">
        ...
        yield "\">Добавить клиента</a>
    </div>
    <div class=\"navigation\">
    ";
        // line 41
        yield $this->env->getRuntime('Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationRuntime')->render($this->env, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 41, $this->source); })()));
        yield "
</div>
";
    ...
    {
        return array (  195 => 41,  189 => 38,  184 => 35,  175 => 31,  173 => 30,  157 => 27,  153 => 26,  148 => 24,  144 => 23,  140 => 22,  136 => 21,  133 => 20,  115 => 19,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"mb-3\">
        <a class=\"btn btn-primary\" href=\"{{ path('app_users_new') }}\">Добавить клиента</a>
    </div>
    <div class=\"navigation\">
    {{ knp_pagination_render(pagination) }}
</div>
{% endblock %}
", "users/index.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/scoring_symfony/templates/users/index.html.twig");
    }
}
