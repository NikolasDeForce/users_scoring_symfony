...
/* base.html.twig */
class __TwigTemplate_b85126af0b0b4398258f69a9e7da50a7 extends Template
{
...
";
    ...
    {
        return array (  191 => 37,  178 => 11,  165 => 10,  153 => 8,  140 => 7,  117 => 6,  104 => 38,  102 => 37,  90 => 28,  84 => 25,  74 => 18,  68 => 14,  65 => 10,  63 => 7,  59 => 6,  52 => 1,);
    }
...
<html>
    <head>
        <meta charset=\"UTF-8\">
        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">
        <title>{% block title %}Scoring{% endblock %}</title>
        {% block stylesheets %}
    ...
    <nav class=\"navbar navbar-expand-lg bg-body-tertiary\">
  <div class=\"container-fluid\">
    <a class=\"navbar-brand\" href=\"{{ path('app_users_index') }}\">SCORING</a>
    <button class=\"navbar-toggler\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbarText\" aria-controls=\"navbarText\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
      <span class=\"navbar-toggler-icon\"></span>
    </button>
    <div class=\"collapse navbar-collapse\" id=\"navbarText\">
      <ul class=\"navbar-nav me-auto mb-2 mb-lg-0\">
        <li class=\"nav-item\">
          <a class=\"nav-link active\" aria-current=\"page\" href=\"{{ path('app_users_index') }}\">Главная</a>
        </li>
        <li class=\"nav-item\">
          <a class=\"nav-link\" href=\"{{ path('app_users_new') }}\">Добавить</a>
        </li>
      </ul>
      <span class=\"navbar-text\">
        Приложение расчета скоринга клиентов
...
", "base.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/scoring_symfony/templates/base.html.twig");
    }
}
