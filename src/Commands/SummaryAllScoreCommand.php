...
#[AsCommand(name: 'score:all')]
class SummaryAllScoreCommand extends Command
{
    ...
    {
        $this->setDescription('Вычисляет общий балл скоринга по всем пользователям')
            ->setHelp('Вычисляет общий балл скоринга по всем пользователям');
    }
...
Общее количество баллов: %s
        ...
        $output->writeln(sprintf('Скоринг по всем клиентам равен %s', $scoring_output));
